...
class Hand:
  ...
  def find_hand_type(self) -> HandType:
    ...
    match unique_cards:
      case 5:
        if 'J' in counts: return HandType.ONE_PAIR
        else: return HandType.HIGH_CARD
      case 4:
        if 'J' in counts: return HandType.THREE_OF_A_KIND
        else: return HandType.ONE_PAIR
      case 3:
        if 2 in counts.values():
          if 'J' in counts and counts['J'] == 1: return HandType.FULL_HOUSE
          elif 'J' in counts and counts['J'] == 2: return HandType.FOUR_OF_A_KIND
          else: return HandType.TWO_PAIR
        if 3 in counts.values():
          if 'J' in counts: return HandType.FOUR_OF_A_KIND
          return HandType.THREE_OF_A_KIND
      case 2:
        if 'J' in counts: return HandType.FIVE_OF_A_KIND
